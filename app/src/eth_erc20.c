...
const erc20_tokens_t supportedTokens[] = {
    ...
    {{0x80, 0xB9, 0x8d, 0x3a, 0xa0, 0x9f, 0xff, 0xf2, 0x55, 0xc3, 0xba, 0x4A, 0x24, 0x11, 0x11, 0xFf, 0x12, 0x62, 0xF0, 0x45},
    "USDFC ",
    18},

    {{0x2a, 0x0a, 0xaf, 0x86, 0xb2, 0xFA, 0x64, 0xE8, 0x8D, 0x37, 0x39, 0x09, 0x1e, 0x77, 0x73, 0x10, 0x6F, 0x3e, 0xbC, 0xF5},
    "GLF ",
    18},
};
